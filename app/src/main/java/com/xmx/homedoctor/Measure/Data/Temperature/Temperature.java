...
import com.xmx.homedoctor.Tools.Data.Sync.ISyncEntity;
...
public class Temperature implements ISyncEntity {
    ...
    public Temperature convertToEntity(AVObject object) {
        ...
        entity.mPatient = object.getString("Patient");
        return entity;
    }
